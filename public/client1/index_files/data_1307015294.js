...
{var std=(this.t&&'std'==this.t)?true:false;if(null==this.t||undefined==this.t||""==this.t)
{this.t='std';std=true;var tN=n.tagName||pN.tagName;if(null!=tN)
{if(tN.toLowerCase)
{tN=tN.toLowerCase();}
if('strong'==tN||'b'==tN)
{this.t='b';}
...
{this.t='l';}}}
var h=this.h||parent.h;if((null==h||undefined==h||h<1)&&('std'==this.t||std))
...
$iTXT.data.Context.harvestedCount++;this.c=content;if('title'==parent.t&&'title'==this.t&&!$iTXT.data.Context.pageTitle)
...
{switch(parent.t)
{case'alt':case'h':case'img':case'meta':case'title':case'url':this.t=parent.t;this.tn=parent.tn;break;}}
if(params.metricID)
...
{return;}}
this.setContextFull();this.setDynamicContentMode();this.setTreeObjectMode();this.setPageTitle();var startNodes=this.getStartNodes();var bAH=$iTXT.core.Browser.useragent.toLowerCase();if('explorer'==bAH)
...
$iTXT.data.AdLogger=$iTXT.core.Class.create({server:"",qavTID:-1,trkDrps:null,pWind:null,pWindName:"",pWindUrl:"",demoMode:false,duplicateAdViews:[],logsInProgress:0,init:function(o)
{if($iTXT.data.al)
{return;}
