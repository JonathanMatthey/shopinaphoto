...
//function for retrieving query variable vars

function getQueryStringValue(name)
{var regexString="[\\?&]"+name+"=([^&#]*)";var regex=new RegExp(regexString);var tmpURL=window.location.href;var results=tmpURL.match(regex);if(results==null)
return"";else
return results[1];}
function setOmniturePageName(baseUrl)
{var pageName="";if(baseUrl=="")
var fileURL=window.location.hostname+window.location.pathname;else
var fileURL=baseUrl;var query_string=window.location.search.split("?")[1];var fish4AdID="adId";var fish4AdIDValue=getQueryStringValue(fish4AdID);if(!query_string)
pageName=fileURL;else if(window.location.hostname.indexOf('fish4')!=-1&&fish4AdIDValue!="")
pageName=fileURL+"?"+fish4AdID+"="+fish4AdIDValue+"[trunc]";else
pageName=fileURL+"?[trunc]";return pageName;}
s_account=s_account+",tmrgroupaggregateprod";var s=s_gi(s_account);s.pageName=setOmniturePageName("");s.server=window.location.protocol+"//"+window.location.hostname;if(location.hostname.indexOf('fish4')){s.charSet="ISO-8859-1";}else{s.charSet="UTF-8";}
s.currencyCode="GBP"
s.trackDownloadLinks=true
s.trackExternalLinks=true
s.trackInlineStats=true
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,doc,pdf,xls,3gp,avi,mpeg,swf,wma,m1v,mp4,flv,rm,divx"
s.linkInternalFilters="javascript:,icnetwork.co.uk,www.fish4.co.uk,mirror.co.uk,sundaymirror.co.uk,people.co.uk,dailyrecord.co.uk,sundaymail.co.uk,business7.co.uk,insider.co.uk,karaokechamp.com,mirrorshopping.co.uk,scotcareers.co.uk,scotwheels.co.uk"
...
s.visitorNamespace="trinitymirror"
s.dc=112
